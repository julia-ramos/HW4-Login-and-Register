...
public class Constants {
	...
	final public static short CMSG_LOGIN = 107;
	final public static short SMSG_LOGIN = 207;
	final public static short CMSG_REGISTER = 108;
	final public static short SMSG_REGISTER = 208;
